...
@widgetbook.UseCase(name: 'Default', type: BottomTabBar)
/// Renders a use case for the Default variant of the BottomTabBar component.
Widget bottomTabBarDefaultUseCase(BuildContext context) {
  return Scaffold(
