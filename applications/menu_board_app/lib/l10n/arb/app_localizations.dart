...
abstract class AppLocalizations {
  ...
  /// The title of the menu board application
  ///
  ...
  /// Placeholder shown in the featured item panel when no item is available
  ///
  /// In en, this message translates to:
  /// **'Not available'**
  String get notAvailable;

  /// Error message shown when the menu fails to load
  ///
  /// In en, this message translates to:
  /// **'Failed to load menu.'**
