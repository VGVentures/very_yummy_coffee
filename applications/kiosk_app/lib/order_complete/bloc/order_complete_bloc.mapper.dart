...
class OrderCompleteStatusMapper extends EnumMapper<OrderCompleteStatus> {
  ...
  OrderCompleteStatus decode(dynamic value) {
    switch (value) {
      ...
      case r'navigatingBack':
        return OrderCompleteStatus.navigatingBack;
      default:
  ...
  dynamic encode(OrderCompleteStatus self) {
    switch (self) {
      ...
      case OrderCompleteStatus.failure:
        return r'failure';
      case OrderCompleteStatus.navigatingBack:
        return r'navigatingBack';
    }
  }
}
...
class OrderCompleteEventMapper extends ClassMapperBase<OrderCompleteEvent> {
  ...
  static OrderCompleteEventMapper ensureInitialized() {
    if (_instance == null) {
      ...
      OrderCompleteDoneRequestedMapper.ensureInitialized();
    }
    return _instance!;
  }
...
class OrderCompleteDoneRequestedMapper
    extends ClassMapperBase<OrderCompleteDoneRequested> {
  OrderCompleteDoneRequestedMapper._();

  static OrderCompleteDoneRequestedMapper? _instance;
  static OrderCompleteDoneRequestedMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = OrderCompleteDoneRequestedMapper._(),
      );
      OrderCompleteEventMapper.ensureInitialized();
    }
    return _instance!;
  ...
  @override
  final String id = 'OrderCompleteDoneRequested';

  @override
  final MappableFields<OrderCompleteDoneRequested> fields = const {};

  static OrderCompleteDoneRequested _instantiate(DecodingData data) {
    return OrderCompleteDoneRequested();
  }

  @override
  final Function instantiate = _instantiate;

  static OrderCompleteDoneRequested fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<OrderCompleteDoneRequested>(map);
  }
...
mixin OrderCompleteDoneRequestedMappable {
  String toJson() {
    return OrderCompleteDoneRequestedMapper.ensureInitialized()
        .encodeJson<OrderCompleteDoneRequested>(
  ...
  Map<String, dynamic> toMap() {
    return OrderCompleteDoneRequestedMapper.ensureInitialized()
        .encodeMap<OrderCompleteDoneRequested>(
          this as OrderCompleteDoneRequested,
        );
  }
  ...
  @override
  int get hashCode {
    return OrderCompleteDoneRequestedMapper.ensureInitialized().hashValue(
      this as OrderCompleteDoneRequested,
    );
  }
}
...
abstract class OrderCompleteDoneRequestedCopyWith<
  $R,
  $In extends OrderCompleteDoneRequested,
  $Out
>
    implements OrderCompleteEventCopyWith<$R, $In, $Out> {
  @override
  $R call();
  OrderCompleteDoneRequestedCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  );
}

class _OrderCompleteDoneRequestedCopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, OrderCompleteDoneRequested, $Out>
    implements
        OrderCompleteDoneRequestedCopyWith<
          $R,
          OrderCompleteDoneRequested,
  ...
  @override
  OrderCompleteDoneRequested $make(CopyWithData data) =>
      OrderCompleteDoneRequested();
